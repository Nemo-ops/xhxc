package com.fh.controller.xhxc.group;
...
public class GroupController extends BaseController {
	...
	String menuUrl = "group/listUsers.do"; //菜单地址(权限用)
	...
	public ModelAndView listUsers(Page page)throws Exception{
		...
		page.setPd(pd);
		List<PageData>	userList = userService.listGroups(page);	//列出用户列表
		pd.put("ROLE_ID", "1");
		List<Role> roleList = roleService.listAllRolesByPId(pd);//列出所有系统用户角色
		mv.setViewName("xhxc/group/group_list");
	...
	public ModelAndView goAddU()throws Exception{
		...
		pd.put("ROLE_ID", "1");
		List<Role> roleList = roleService.listAllRolesByPId(pd);//列出所有系统用户角色
		mv.setViewName("xhxc/group/group_edit");
	...
	public ModelAndView view() throws Exception{
		...
		mv.setViewName("xhxc/group/user_view");
		mv.addObject("msg", "editU");
		mv.addObject("pd", pd);
		mv.addObject("roleList", roleList);
		return mv;
	...
	public ModelAndView goUploadExcel()throws Exception{
		ModelAndView mv = this.getModelAndView();
		mv.setViewName("xhxc/group/uploadexcel");
		return mv;
	}
	...
	public ModelAndView listUsersForWindow(Page page)throws Exception{
		...
		pd.put("ROLE_ID", "1");
		List<Role> roleList = roleService.listAllRolesByPId(pd);//列出所有系统用户角色
		mv.setViewName("xhxc/group/window_user_list");
		mv.addObject("userList", userList);
		mv.addObject("roleList", roleList);
		mv.addObject("pd", pd);
		mv.addObject("QX",Jurisdiction.getHC());	//按钮权限
