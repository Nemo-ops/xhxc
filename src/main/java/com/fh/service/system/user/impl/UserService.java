...
public class UserService implements UserManager{
	...
	public List<PageData> listHelpers(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.helperlistPage", page);
	}

	public List<PageData> listSchools(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.schoollistPage", page);
	}

	public List<PageData> listGroups(Page page) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.grouplistPage", page);
	}
